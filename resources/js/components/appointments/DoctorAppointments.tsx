        ...
        <Box sx={{ p: { xs: 2, md: 3 }, minHeight: '100vh', bgcolor: '#fafafa' }}>
            ...
            <Card elevation={0} sx={{ mb: 4, borderRadius: 3, border: '1px solid #e0e0e0' }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    ...
                    >
                        <Tab icon={<ListIcon />} label="Patient Appointments List" iconPosition="start" />
            ...
            {appointments.data.length === 0 ? (
                ...
                <Box>
                    ...
                    {activeTab === 1 && <AppointmentCalendar appointments={appointments.data} userRole="provider" />}
                </Box>
            )}
            ...
            <Dialog open={updateDialogOpen} onClose={() => setUpdateDialogOpen(false)} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    <Box display="flex" flexDirection="column" gap={2} mt={1}>
                        ...
                        <FormControl fullWidth>
                            <InputLabel>Payment Status</InputLabel>
                            <Select value={newPaymentStatus} label="Payment Status" onChange={(e) => setNewPaymentStatus(e.target.value)}>
                                <MenuItem value="pending">Pending</MenuItem>
                                <MenuItem value="on_hold">On Hold</MenuItem>
                                <MenuItem value="paid">Paid</MenuItem>
                            </Select>
            ...
            <Dialog open={appointmentDetailsOpen} onClose={() => setAppointmentDetailsOpen(false)} maxWidth="md" fullWidth>
                <DialogTitle sx={{ pb: 1 }}>
                ...
                <DialogActions sx={{ p: 3, borderTop: '1px solid #e0e0e0' }}>
                    <Button onClick={() => setAppointmentDetailsOpen(false)} variant="outlined" sx={{ px: 4 }}>
                        Close
                    </Button>
                </DialogActions>
            </Dialog>
