        ...
        <Box sx={{ p: { xs: 2, md: 3 }, minHeight: '100vh', bgcolor: '#fafafa' }}>
            ...
            <Card elevation={0} sx={{ mb: 4, borderRadius: 3, border: '1px solid #e0e0e0' }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    ...
                    >
                        <Tab icon={<ListIcon />} label="Patient List View" iconPosition="start" />
                        <Tab icon={<CalendarIcon />} label="Calendar Overview" iconPosition="start" />
                    </Tabs>
                </Box>
            </Card>
                                ...
                                <Table sx={{ minWidth: 1200 }}>
                                    <TableHead>
                                        <TableRow sx={{ bgcolor: '#5c6bc0' }}>
                                            ...
                                            <TableCell align="right" sx={{ color: 'white', fontWeight: 600, py: 2, minWidth: 180 }}>
                                                Actions
                                            </TableCell>
                                        </TableRow>
                                    </TableHead>
                                                ...
                                                >
                                                        ...
                                                        <Tooltip
                                                            title={
                                                                isAdmin
                                                                    ...
                                                                    : 'Click to cycle: Pending → Confirmed → Cancelled'
                                                            }
                                                            arrow
                                                        >
                                                            <Chip
                                                    ...
                                                    <TableCell sx={{ py: 3, minWidth: 120 }}>
                                                        <Box display="flex" flexDirection="column" gap={1}>
                                                            <Tooltip
                                                                title={isAdmin ? 'Read-only for admin users' : 'Click to toggle payment status'}
                                                                arrow
                                                            >
                                                                <Chip
                                                                        ...
                                                                        isAdmin
                                                                            ...
                                                                            : () => {
                                                                                  const newPaymentStatus =
                                                                                      appointment.payment_status === 'pending' ? 'paid' : 'pending';
                    ...
                    {activeTab === 1 && (
                        <Box>
                                ...
                                <CardContent sx={{ p: 3 }}>
                                    <Stack direction="row" alignItems="center" spacing={3}>
                                        ...
                                        {calendarProviderFilter && (
                                            <Button variant="outlined" color="error" size="small" onClick={() => setCalendarProviderFilter('')}>
                                                Clear Filter
                                            </Button>
                                        )}
                                    </Stack>
                            ...
                            <AppointmentCalendar
                                ...
                                userRole="admin"
                                selectedProvider={
                                    calendarProviderFilter ? providers.find((p) => p.id.toString() === calendarProviderFilter) : undefined
                                }
                            />
                        </Box>
                    )}
            ...
            <Dialog open={authDialogOpen} onClose={handleAuthCancel} maxWidth="sm" fullWidth>
                <DialogTitle sx={{ color: '#d32f2f', fontWeight: 'bold' }}>⚠️ Administrative Action Required</DialogTitle>
                <DialogContent>
                    ...
                    >
                        <strong>Important:</strong> This action is primarily intended for healthcare providers. Admin access is provided for
                        exceptional circumstances only, such as:
                ...
                <DialogActions sx={{ p: 3, gap: 2 }}>
                    <Button onClick={handleAuthCancel} variant="outlined" sx={{ px: 4, py: 1 }}>
                        Cancel
                    </Button>
                    <Button onClick={handleAuthConfirm} variant="contained" color="error" sx={{ px: 4, py: 1 }}>
