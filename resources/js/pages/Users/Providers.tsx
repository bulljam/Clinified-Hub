...
export default function Providers({ providers, userRole }: ProvidersProps) {
                        ...
                        <Table sx={{ minWidth: 800 }}>
                            ...
                            <TableBody>
                                {paginatedProviders.map((provider, index) => (
                                    <Fade in={true} timeout={300 + index * 100} key={provider.id}>
                                        <TableRow 
                                            hover
                                            sx={{
                                                '&:hover': {
                                        ...
                                        >
                                            ...
                                            <TableCell sx={{ py: 3, minWidth: 150 }}>
                                                <Typography variant="body2">
                                                    {dayjs(provider.created_at).format('MMM D, YYYY')}
                                                </Typography>
                                            </TableCell>
                ...
                {filteredProviders.length === 0 && (
                    <Card elevation={0} sx={{ borderRadius: 3, border: '1px solid #e0e0e0' }}>
                        <CardContent sx={{ textAlign: 'center', py: 8 }}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                {searchQuery ? 'Try adjusting your search criteria.' : 'No healthcare providers are currently available.'}
                            </Typography>
                        </CardContent>
                    </Card>
                )}
