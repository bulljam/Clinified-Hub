        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Box sx={{ p: 3 }}>
                    ...
                    <CardContent>
                        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} alignItems="center">
                            ...
                            <FormControl sx={{ minWidth: 120 }}>
                                ...
                                <Select value={perPage} label="Per Page" onChange={(e) => handlePerPageChange(Number(e.target.value))}>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {admins.data.map((admin) => (
                                    <TableRow key={admin.id} hover sx={{ '&:hover': { bgcolor: '#fafbfc' } }}>
                                        <TableCell>
                ...
                <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)} maxWidth="sm" fullWidth>
                    <DialogTitle sx={{ fontWeight: 600, color: '#dc2626' }}>Confirm Delete</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
                            Are you sure you want to delete <strong>{adminToDelete?.name}</strong>? This action cannot be undone and will permanently
